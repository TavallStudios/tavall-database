# Contributing to tavall-database

This repository is the canonical standalone source of truth for `tavall-database`.

## Development workflow

1. Clone or fetch this repository:
   ```bash
   git clone https://github.com/TavallStudios/tavall-database.git
   ```
